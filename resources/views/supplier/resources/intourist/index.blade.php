    ...
    <div class="page-list">
        <div class="row page-list-header">
            <div class="col-xs-8 text-left">
                <a href="{{url('/supplier/resources/intourist/create/')}}"
                            ...
                            @foreach($intourists as $item)
                                <tr>
                                    ...
                                    <td style="text-align: center"><a
                                                href="{{url('/supplier/resources/intourist/edit/'.$item->id)}}">编辑</a>
                                        |
                                        <a
                                                href="{{url('/supplier/resources/intourist/delete/'.$item->id)}}">删除</a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
