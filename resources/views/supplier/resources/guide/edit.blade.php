...
@section('content')
    <div class="  page-input">
        <form class="form-horizontal" method="Post"
              enctype="multipart/form-data" action="{{url('/supplier/resources/guide/edit/'.$guide->id)}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <textarea id="remark" name="remark" class="form-control"
                                          style="width: 1005px;height: 120px;">{{$guide->remark}}</textarea>
