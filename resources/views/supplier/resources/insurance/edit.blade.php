...
@section('content')
    <div class="  page-input">
        <form class="form-horizontal" method="Post"
              enctype="multipart/form-data" action="{{url('/supplier/resources/insurance/edit/'.$insurance->id)}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <input id="linkman" name="linkman" class="form-control"
                                       style="width: 200px;"
                                       value="{{$insurance->linkman}}" type="text"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <input id="mobile" name="mobile" class="form-control"
                                       style="width: 300px;"
                                       value="{{$insurance->mobile}}" type="text"/>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10">
                                <textarea id="remark" name="remark" class="form-control"
                                          style="width: 1005px;height: 120px;">{{$insurance->remark}}</textarea>
